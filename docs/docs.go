...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/teams/{teamId}/accept/{userId}": {
            "post": {
        ...
        "/auth/teams/{teamId}/invite/{targetId}": {
            "post": {
        ...
        "/auth/teams/{teamId}/remove/{userId}": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AuthorizeRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.AuthorizeResponse"
                                        }
                                    }
                                }
                            ]
