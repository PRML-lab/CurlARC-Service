...
type UserUsecase interface {
	...
	AuthUser(ctx context.Context, id_token string) (*model.User, *http.Cookie, error)
...
func (usecase *userUsecase) AuthUser(ctx context.Context, id_token string) (*model.User, *http.Cookie, error) {
