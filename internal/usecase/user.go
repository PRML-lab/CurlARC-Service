...
type UserUsecase interface {
	...
	AuthUser(ctx context.Context, id_token string) (*entity.User, *http.Cookie, error)
...
func (usecase *userUsecase) AuthUser(ctx context.Context, id_token string) (*entity.User, *http.Cookie, error) {
	...
	if err != nil {
		return nil, nil, repository.ErrUnauthorized
	}
