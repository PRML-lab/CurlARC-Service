...
// Source: firebase.google.com/go/v4/firebaseAuth
...
func (m *MockAuthClient) VerifyIDToken(ctx context.Context, idToken string) (*firebaseAuth.Token, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyIDToken", ctx, idToken)
	ret0, _ := ret[0].(*firebaseAuth.Token)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAuthClient) UpdateUser(ctx context.Context, uid string, user *firebaseAuth.UserToUpdate) (*firebaseAuth.UserRecord, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUser", ctx, uid, user)
	ret0, _ := ret[0].(*firebaseAuth.UserRecord)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
